...
def generate_launch_description():
    ...
    # NO GAZEBO LAUNCH - key difference from blimp_only (assumes Gazebo already running)
    ...
    blimp_group = GroupAction([
        ...
        # NOTE: This needs to be migrated to ROS2 - see migration instructions below
        Node(
        ...
        # ROS2ROSHITL Node (EXACT ROS1 equivalent with same remappings)
        # NOTE: This needs roshitl package migrated to ROS2 - see instructions below
        Node(
            package='roshitl',
            executable='ros2roshitl.py',
            name='ros2roshitl',
            output='screen',
            remappings=[
                ('GCSIMU', 'tail/imu'),
                ('GCSPOS', 'tail/pose_with_drift'),  # EXACT ROS1 remapping
                ('GCSVEL', 'ground_speed'),
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('enable_meshes', default_value='false'),   # ROS1 original: false
        ...
        DeclareLaunchArgument('enable_mavlink_interface', default_value='true'), # ROS1 original: TRUE (key diff)
        ...
        DeclareLaunchArgument('Z', default_value='10.0'),  # ROS1 original: 10.0 (key difference from blimp_only)
        
        # NO Gazebo launch - key difference from blimp_only.launch
