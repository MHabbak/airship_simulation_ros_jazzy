...
def generate_launch_description():
    ...
    # EXACT ROS1 equivalent: include blimp_with_env.launch with spring_damper_test world + rviz
    blimp_with_env_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'world_name': LaunchConfiguration('world_name'),  # KEY: spring_damper_test world
    ...
    # EXACT ROS1 equivalent: RViz node with specific config
    rviz_node = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            os.path.join(get_package_share_directory('rviz2'), 'launch', 'rviz2.launch.py')
        ]),
        launch_arguments={
    ...
    return LaunchDescription([
        # Declare arguments (EXACT ROS1 equivalents with KEY DIFFERENCE: spring_damper_test world)
        ...
        DeclareLaunchArgument('world_name', default_value='spring_damper_test'), # KEY DIFFERENCE: special world
        ...
        # Include blimp with environment (spring damper test world)
        blimp_with_env_launch,
        
        # Launch RViz (EXACT ROS1 equivalent)
        rviz_node,
    ])